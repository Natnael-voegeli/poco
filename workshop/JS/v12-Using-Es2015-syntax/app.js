  ...
  ulEvents: function() {
    ...
    ul.addEventListener('click', function(event) {
      ...
      if(elemClicked.tagName === 'BUTTON') {
        ...
        if(confirm(`Are you sure to delete the index n° ${elemClicked.id} index ?`)) {
...
let bob2 =  "I'm Bob!"; //console.log(bob1());
...
// The way with template literals
